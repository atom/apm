  ...
  parseOptions: (argv) ->
    ...
    options.usage """
      Usage:
        ...
        apm init -t [--dark | --light] <theme-name>
    ...
    options.string('dark').describe('dark', 'Generates a basic dark interface theme')
    options.string('light').describe('light', 'Generates a basic light interface theme')
